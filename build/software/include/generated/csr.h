...
/* I2C */
#define CSR_I2C_BASE 0xe0009000
#define CSR_I2C_CONFIG_ADDR 0xe0009000
#define CSR_I2C_CONFIG_SIZE 4
static inline unsigned int I2C_config_read(void) {
	unsigned int r = csr_readl(0xe0009000);
	r <<= 8;
	r |= csr_readl(0xe0009004);
	r <<= 8;
	r |= csr_readl(0xe0009008);
	r <<= 8;
	r |= csr_readl(0xe000900c);
	return r;
}
static inline void I2C_config_write(unsigned int value) {
	csr_writel(value >> 24, 0xe0009000);
	csr_writel(value >> 16, 0xe0009004);
	csr_writel(value >> 8, 0xe0009008);
	csr_writel(value, 0xe000900c);
}
#define CSR_I2C_XFER_ADDR 0xe0009010
#define CSR_I2C_XFER_SIZE 4
static inline unsigned int I2C_xfer_read(void) {
	unsigned int r = csr_readl(0xe0009010);
	r <<= 8;
	r |= csr_readl(0xe0009014);
	r <<= 8;
	r |= csr_readl(0xe0009018);
	r <<= 8;
	r |= csr_readl(0xe000901c);
	return r;
}
static inline void I2C_xfer_write(unsigned int value) {
	csr_writel(value >> 24, 0xe0009010);
	csr_writel(value >> 16, 0xe0009014);
	csr_writel(value >> 8, 0xe0009018);
	csr_writel(value, 0xe000901c);
}
#define CSR_I2C_START_ADDR 0xe0009020
#define CSR_I2C_START_SIZE 1
static inline unsigned char I2C_start_read(void) {
	unsigned char r = csr_readl(0xe0009020);
	return r;
}
static inline void I2C_start_write(unsigned char value) {
	csr_writel(value, 0xe0009020);
}
#define CSR_I2C_ACTIVE_ADDR 0xe0009024
#define CSR_I2C_ACTIVE_SIZE 1
static inline unsigned char I2C_active_read(void) {
	unsigned char r = csr_readl(0xe0009024);
	return r;
}
#define CSR_I2C_PENDING_ADDR 0xe0009028
#define CSR_I2C_PENDING_SIZE 1
static inline unsigned char I2C_pending_read(void) {
	unsigned char r = csr_readl(0xe0009028);
	return r;
}
#define CSR_I2C_MOSI_DATA_ADDR 0xe000902c
#define CSR_I2C_MOSI_DATA_SIZE 4
static inline unsigned int I2C_mosi_data_read(void) {
	unsigned int r = csr_readl(0xe000902c);
	r <<= 8;
	r |= csr_readl(0xe0009030);
	r <<= 8;
	r |= csr_readl(0xe0009034);
	r <<= 8;
	r |= csr_readl(0xe0009038);
	return r;
}
static inline void I2C_mosi_data_write(unsigned int value) {
	csr_writel(value >> 24, 0xe000902c);
	csr_writel(value >> 16, 0xe0009030);
	csr_writel(value >> 8, 0xe0009034);
	csr_writel(value, 0xe0009038);
}
#define CSR_I2C_MISO_DATA_ADDR 0xe000903c
#define CSR_I2C_MISO_DATA_SIZE 4
static inline unsigned int I2C_miso_data_read(void) {
	unsigned int r = csr_readl(0xe000903c);
	r <<= 8;
	r |= csr_readl(0xe0009040);
	r <<= 8;
	r |= csr_readl(0xe0009044);
	r <<= 8;
	r |= csr_readl(0xe0009048);
	return r;
}
